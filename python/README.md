## Geospatial Python Scripts and Notebook
...
- [`ghcn.ipynb`](https://github.com/spatialthoughts/projects/blob/master/python/unpivot.ipynb): Convert GHCN FWF files to XLSX
